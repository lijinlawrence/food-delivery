      ...
      <div className=" py-20 flex flex-col md:flex-row-reverse justify-between items-center gap-8">
          ...
          <div className=" flex flex-col md:flex-row items-center justify-around -mt-14 gap-4">
            <div className=" flex bg-white py-2 px-3 rounded-2xl items-center gap-3 shadow-md w-64" >
              <img src={food1} alt="food1" className=" rounded-2xl" />
        ...
        <div className=" md:w-1/2 space-y-7 px-4">
          ...
          <button className=" btn bg-green rounded-full px-6 text-white flex items-center gap-2 border-none hover:text-green  font-semibold">
            Order Now
          </button>
        </div>
